  ...
  return (
    <div className="relative">
      {/* <img
                  ...
                  alt="map"
                  /> */}
      <div className="xl:mx-auto xl:container relative m-2 mb-4 bg-gray-200 rounded-xl">
              ...
              <div className="w-full 2xl:pl-20 xl:pt-1">
                ...
                <div className="w-full md:w-10/12 mt-3">
                  <h2 className="text-gray-800 text-base md:text-lg leading-8 tracking-wider">
                    ...
                    bawah ini, dan tim kami akan dengan senang hati membantu
                    Anda.
                  </h2>
